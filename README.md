...
This project is a programmatic Rubik’s Cube simulator built as a .NET 8 Console Application. It allows rotation of all cube faces, displays the cube in an exploded view.
...
Any IDE supporting .NET (Visual Studio, VS Code)
...
The program will start in console mode and display the exploded view of the cube. It also shows the available commands for rotating each face:
...
Enter a command and the cube will update and print the new exploded view.
...
Clockwise + counter-clockwise rotation returns to initial state
